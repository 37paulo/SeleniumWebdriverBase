...
public class LoginPage extends RunCucumber {
    ...
    private By botaoFazerLogin = By.xpath("//*[@id=\"btnLogin\"]");
    ...
    public void preencheEmail(String email){
        informarDados(campoEmail,email);
    }

    public void preencherSenha(String senha){
        informarDados(campoSenha,senha);
    }
    ...
    public void verificaLoginSucesso(){
        checkMessagem(By.id("swal2-title"), "Login realizado");

    }

    public void verificaCampoVazio(String message){
        checkMessagem(By.className("invalid_input"),message);
